export default {
  ...
  admin: {
    ...
    subscriptions: {
      ...
      // M22 · /(admin)/monetization/subscriptions 管理员面板
      desc: '实时订阅总账 · 管理取消、退款与延期',
      statActive: '生效中',
      statCancelled: '已取消',
      statRevenue: '本月收入',
      statusAll: '全部状态',
      ...
      extendConfirm: '延期',
      extendSuccess: '订阅已延期',
      extendError: '延期失败：{error}',
      cancelReason: '取消原因',
      cancelReasonPlaceholder: '必填（≥ 4 字符）',
      cancelReasonRequired: '请填写取消原因（≥ 4 字符）',
      cancelConfirm: '强制取消',
      cancelSuccess: '订阅已取消',
      cancelError: '取消失败：{error}'
    },

    refund: {
      title: '发起退款',
      description: '退款将通过原支付渠道处理',
      amount: '金额',
      maxHint: '最多 ${max}',
      reason: '退款原因',
      reasonPlaceholder: '请说明本次退款的原因',
      notifyUser: '通过邮件通知用户',
      confirm: '退款',
      submitting: '退款中…',
      success: '退款已发起',
      error: '退款失败：{error}',
      errorAmountInvalid: '金额必须大于 0',
      errorAmountExceeds: '金额超过可退余额（最多 ${max}）',
      errorReasonRequired: '请填写退款原因（≥ 4 字符）',
    },

    // M12 · /(admin)/orders/list 管理员面板
    orders: {
      title: '订单管理',
      desc: '订单总账 · 复核支付、退款、重试与取消',
      statRevenue: '收入',
      statRefunds: '退款',
      statCancellations: '已取消',
      searchPlaceholder: '搜索订单号 / 用户邮箱 / ID…',
      statusAll: '全部状态',
      providerLabel: '渠道',
      providerAll: '全部渠道',
      planLabel: '套餐',
    ...
    // M12 · /(admin)/orders/dashboard 收入看板
    orderDashboard: {
      title: '收入看板',
      desc: '收入总账 · 实时 KPI · 渠道拆分',
      daySuffix: '天',
      stat: {
        todayRevenue: '今日收入',
        todayOrders: '今日订单',
    ...
    // M12 · /(admin)/orders/payments 重定向 / 合并说明
    orderPayments: {
      title: '支付套餐',
      desc: '该面板已合并到 Plan Catalog',
      noticeTitle: '套餐编辑入口已迁移',
      noticeBody:
        '支付套餐与订阅套餐共用同一份后端表 (/admin/payment/plans)。为避免双源漂移，所有套餐 CRUD 已统一收口在 Monetization · Plan Catalog 一个入口。',
      gotoPlans: '打开 Plan Catalog',
      gotoSettings: '支付渠道配置',
      docTitle: '入口迁移对照',
      docPlans:
        '订阅 / 充值套餐 CRUD（新建 / 编辑 / 归档 / 复制 / 排序） → Monetization · Plan Catalog',
      docProviders: '支付渠道实例与全局支付配置 → Platform · Settings（支付段）',
      docDashboard: '收入 / 退款 / 流失 KPI → Orders · 收入看板'
    },

    // /(admin)/orders/refunds 退款审核队列
    refunds: {
      title: '退款审核',
      desc: '复核待审退款申请 · 通过 / 驳回需带原因',
      statPending: '待审',
      statAmount: '申请金额',
      statusAll: '全部状态',
      ...
      colRequestedAt: '申请时间',
      colStatus: '状态',
      emptyText: '当前筛选下暂无退款申请',
      view: '查看',
      approve: '通过',
      reject: '驳回',
      approveSuccess: '退款已通过',
      approveError: '通过失败：{error}',
      rejectTitle: '驳回退款申请',
      rejectDescription: '用户将在订单历史中看到该原因。',
      rejectReason: '驳回原因',
      rejectReasonPlaceholder: '请说明驳回原因',
      rejectReasonRequired: '请填写驳回原因（≥ 4 字符）',
      rejectSubmitting: '驳回中…',
      rejectSuccess: '已驳回退款申请',
      rejectError: '驳回失败：{error}',
      detailTitle: '退款申请详情',
      reviewer: '审核人',
      reviewerNote: '审核备注',
      status: {
    ...
    settings: {
      ...
      defaults: {
        ...
        customGroupId: '自定义分组 ID',
        customGroupIdPlaceholder: '分组 ID',
        loadingGroups: '正在加载分组...',
        groupLoadFailed: '无法加载分组，请手动输入分组 ID。',
      ...
      gatewayForwarding: {
        ...
        claudeOAuthSystemPromptInjectionHint: '为非 Claude Code 客户端的 Claude OAuth 请求注入 Claude Code 形态的 system blocks。默认开启；关闭后透传客户端原始 system prompt。',
        claudeOAuthSystemPrompt: 'Claude OAuth 扩展提示词',
        claudeOAuthSystemPromptPlaceholder: '留空时使用内置 Claude Code 扩展提示词。',
        claudeOAuthSystemPromptHint: '仅控制第三个（扩展）注入的 system block 内容。需要完全自定义时改下方的 Blocks JSON。',
        ...
        claudeOAuthSystemPromptBlocksHint: '每个 block 含 enabled、type、text、可选 cache_control。占位符：{billing_header}、{cc_version}、{fp}、{claude_code_system_prompt}、{claude_code_expansion_prompt}。cache_control 接受 true（ephemeral 5m）、false/null（不带）或对象。',
      ...
      webSearchEmulation: {
        ...
        proxy: '代理',
        noProxy: '不使用代理',
        customProxyId: '自定义代理 ID',
        customProxyIdPlaceholder: '代理 ID',
        loadingProxies: '正在加载代理...',
        proxyLoadFailed: '无法加载代理，请手动输入代理 ID。',
        removeProvider: '删除',
      ...
      payment: {
        ...
        providerConfig: '凭证配置',
        invalidConfigJson: '凭证配置必须是 JSON 对象',
        invalidLimitsJson: '限额配置必须是合法 JSON',
    ...
    accounts: {
      ...
      editSelected: '编辑选中',
      deleteSelected: '删除选中',
      refreshFiltered: '刷新筛选',
      refreshFilteredTitle: '刷新筛选账号',
      editFiltered: '编辑筛选',
      deleteFilteredTitle: '删除筛选账号',
      filteredBulkDesc: '此操作将影响符合当前筛选条件的所有账号。',
      noResults: '无账户匹配当前筛选条件。',
      activated: '已启用',
      disabled: '已禁用',
      enable: '启用',
      disable: '禁用',
      ...
      clearErr: '清除错误',
      errorCleared: '错误已清除',
      errorsCleared: '错误已全部清除',
      refreshed: '已刷新',
      holdCleared: '已清除临时不可调度',
      ...
      form: {
        name: '名称', email: '邮箱', notes: '备注', notesPlaceholder: '可选备注信息',
        platform: '平台', type: '类型', status: '状态', proxyId: '代理 ID',
        credentials: '凭证', switchRawJson: '切换到原始 JSON', switchStructured: '切换到结构化',
        apiKey: 'API 密钥', baseUrl: '接口地址', baseUrlHint: '自定义 API 端点，留空使用默认值。',
        orgId: '组织 ID', projectId: '项目 ID', tierId: '层级 ID',
        interceptWarmup: '拦截预热请求', webSearch: '网页搜索模式',
        oauthHint: 'OAuth 凭证通过重新认证流程管理，可用原始 JSON 手动编辑。',
        credentialsJson: '凭证 JSON',
        priority: '优先级', weight: '权重', concurrency: '并发数', rateMultiplier: '费率倍率',
        groupIds: '分组 ID', schedulable: '可调度', privacyMode: '隐私模式', poolMode: '池模式',
        modelRestriction: '模型限制',
      },
      data: {
        batchCreate: '批量创建', batchCreateHint: '粘贴账号 JSON 数组。',
        createBatchBtn: '批量创建', batchCreated: '批量创建成功',
        selectedUpdates: '选中更新', selectedUpdatesHint: '对选中账号应用 JSON 更新或单个凭证字段。',
        credFieldPlaceholder: '凭证字段', credValuePlaceholder: '凭证值或 JSON',
        updateCredBtn: '更新凭证', credUpdated: '凭证已更新',
        applyUpdateBtn: '应用更新', updated: '账号已更新',
        importExport: '导入 / 导出数据', importExportHint: '将选中账号导出为 JSON，或粘贴数据导入。',
        importBtn: '导入数据', imported: '已导入', exported: '已导出',
        mustBeArray: '必须是数组或 { accounts: [] }',
      },
      tools: {
        requests: '请求数', tokens: 'Token 数', cost: '费用', usageSource: '用量来源',
        runtimeActions: '运行时操作', runtimeActionsHint: '上游账号健康和配额的运维控制。',
        stateRecovered: '状态已恢复', rateLimitCleared: '限速已清除', quotaReset: '配额已重置',
        models: '模型', modelsHint: '支持的上游模型列表。',
        scheduledTests: '定时测试', scheduledTestsHint: '运行定期账号连通性测试。',
        testModel: '测试模型', mode: '模式', manualModel: '手动模型', imagePrompt: '图片提示',
        readyTest: '准备就绪，可测试账号连通性。',
        openaiResetCredits: 'OpenAI 重置额度', openaiResetHint: '查询上游重置额度后消耗一个重置。',
        queryQuota: '查询 OpenAI 配额', useResetCredit: '使用重置额度',
        modelId: '模型 ID', cron: 'Cron 表达式', maxResults: '最大结果数',
        enabled: '启用', autoRecover: '自动恢复',
        savePlan: '保存计划', saveEdit: '保存编辑', addPlan: '添加计划',
        noModels: '暂无已报告的模型。', noPlans: '暂无定时测试计划。',
        loadingResults: '加载结果中...', noResults: '暂无结果。',
        hideResults: '收起结果', results: '结果',
        planUpdated: '计划已更新', planDeleted: '计划已删除',
        modelCronRequired: '模型和 Cron 必填',
      },
      advanced: {
        errorPassthroughRules: '错误透传规则', createRule: '创建透传规则',
        username: '用户名', password: '密码', syncProxies: '同步代理',
      },
      reauth: {
        mode: '模式', state: '状态', code: '授权码', exchangeCode: '交换授权码',
        cookieKey: 'Cookie 会话密钥',
      },
      modelWhitelist: {
        noSelected: '未选择模型', noMatching: '无匹配模型', clearAll: '清除全部',
        customModel: '自定义模型', add: '添加',
      },
    },
    ...
    accountsQuench: {
      ...
      autoRefreshTitle: '自动刷新设置',
      enableAutoRefresh: '启用自动刷新',
      refreshInterval5s: '5 秒',
      refreshInterval10s: '10 秒',
      refreshInterval15s: '15 秒',
      refreshInterval30s: '30 秒',
      listPendingSyncHint: '列表有新变更',
      listPendingSyncAction: '刷新查看',
      columnSettingsLabel: '列显示',
      columnSettingsTitle: '列显隐配置',
      columnSettingsReset: '重置为默认',
      columnSettingsHidden: '已隐藏 {n} 列',
      filterSchedulable: '可调度',
      filterSchedulableYes: '可调度',
      filterSchedulableNo: '不可调度',
      filterHasProxy: '代理',
      filterHasProxyYes: '有代理',
      filterHasProxyNo: '无代理',
      filtersToggleShow: '筛选',
      filtersToggleHide: '收起筛选',
      filtersClearAll: '清空',
      bulkDeleteFiltered: '删除当前筛选',
      bulkEditFiltered: '编辑当前筛选',
      bulkRetryFailed: '重试失败项',
      bulkDeleteFilteredTitle: '删除筛选范围内所有账号',
      bulkDeleteFilteredMsg: '将删除符合当前筛选的 {count} 个账号，此操作不可恢复。',
      bulkDeleteNoMatch: '当前筛选无匹配账号。',
      bulkDeletePartial: '部分失败：成功 {success}，失败 {failed}。',
      bulkDeleteSuccess: '已删除 {count} 个账号。',
      bulkSchedulableEnabled: '已启用 {count} 个账号调度。',
    ...
    accountTablePanel: {
      ...
      compactAuto: 'Auto',
      compactLastChecked: '上次检查',
      proxyFallbackActive: '回退中',
      proxyFallbackOriginTip: '已从代理 #{origin} 回退',
      proxyRevert: '还原',
      proxyRevertSuccess: '已还原至原代理。',
      proxyRevertFailed: '还原失败。',
      proxyDaysRemaining: '剩余 {days}d',
      proxyExpired: '已过期',
    },
    ...
    pricingList: {
      title: 'PayGo 计价',
      subtitle: '浏览所有可计费模型及其官方定价，点击行查看多供应商明细与覆盖。',
      totalCount: '个模型可计费',
      sourceHint: '来源：OpenRouter + LiteLLM',
      ...
      unknownProvider: '其他',
      search: {
        placeholder: '按 model id 或名称模糊搜索…',
      },
      provider: {
        label: '供应商',
        allOption: '全部供应商',
      ...
      sort: {
        label: '排序',
        providerGroup: '按供应商分组',
        alphaAsc: '按模型名升序',
        inputAsc: 'Input 价升序',
        inputDesc: 'Input 价降序',
        outputAsc: 'Output 价升序',
        outputDesc: 'Output 价降序',
        contextDesc: 'Context 长降序',
      },
      onlyOverridden: '仅显示已覆盖',
      providerTabs: {
        all: '全部',
      },
      mainstreamHint: '精选主流供应商',
      overrideTooltip: '已覆盖',
      mainstreamSummary: '{models} 个模型 · {providers} 个主流供应商',
      columns: {
        model: '模型',
        provider: '供应商',
        input: 'Input',
      ...
      empty: {
        title: '目录暂无模型',
        hint: '点击同步目录，从 OpenRouter 拉取最新模型与定价。',
        action: '同步目录',
      },
    },
    ...
    plansCatalog: {
      ...
      tabQuotas: '配额',
      tabFeatures: '特性',
      dialogDesc: '配置套餐元数据、价格与权益',
      quotasFromGroup: '配额从所选分组继承',
      quotasNeedGroup: '请在「基本信息」标签先选择分组以查看继承配额',
      unitDays: '天',
      unitWeeks: '周',
      unitMonths: '月',
    },
  ...
  user: {
    ...
    keys: {
      pageTitle: 'API 密钥',
      pageSubtitle: '创建并管理用于程序化访问 API 的密钥。',
      newKey: '新建 API 密钥',
      refresh: '刷新',
      retry: '重试',
      loading: '加载中…',
      ...
      emptyDescription: '创建第一把密钥即可开始调用 API。',
      createFirstKey: '创建第一把密钥',
      createTitle: '创建 API 密钥',
      createDescription: '生成一把用于 API 访问的新密钥。',
      revealTitle: '保存你的新密钥',
      revealDescription: '请立刻复制此密钥，它只显示这一次。',
      revealWarning: '完整密钥仅此一次显示，请妥善保存。',
      mustSaveKeyWarning: '请先复制密钥或勾选已保存确认后再关闭。',
      savedAcknowledge: '我已将此密钥安全保存',
      copyToClipboard: '复制到剪贴板',
      copiedToast: '已复制到剪贴板',
      ...
      nameLabel: '名称',
      namePlaceholder: '我的 API 密钥',
      quotaLabel: '配额（USD，可选）',
      quotaPlaceholder: '留空表示无限',
      expiresLabel: '过期天数（可选）',
      expiresPlaceholder: '例如 30 — 留空表示永不过期',
      createSuccess: 'API 密钥创建成功',
      failedToLoad: 'API 密钥加载失败',
      revoke: '撤销',
      revoking: '撤销中...',
      revokeAria: '撤销密钥',
      revokeTitle: '撤销此 API 密钥？',
      revokeDescription: '将永久撤销以 {prefix}... 开头、{suffix} 结尾的密钥。此操作不可逆。',
      revokeSuccess: 'API 密钥已撤销',
      revokeError: '撤销 API 密钥失败',
      errors: {
        NAME_REQUIRED: '请填写名称',
        NAME_TOO_LONG: '名称长度不能超过 64 字符',
        QUOTA_NEGATIVE: '配额必须为非负数',
        EXPIRES_INT: '过期天数必须为整数',
        EXPIRES_MIN: '过期天数至少为 1 天',
        EXPIRES_MAX: '过期天数不能超过 365 天',
        UNKNOWN: '未知错误',
      },
    },
    subscriptions: {
      pageTitle: '我的订阅',
      pageSubtitle: '管理当前订阅并查看历史订阅。',
      refresh: '刷新',
      retry: '重试',
      failedToLoad: '订阅加载失败',
      currentLabel: '当前订阅',
      startedAt: '开始时间',
      renewsAt: '续费时间',
      expiringSoon: '订阅即将到期，请及时续费以保持访问。',
      cancel: '取消订阅',
      upgrade: '升级',
      browsePlans: '浏览套餐',
      emptyTitle: '暂无活跃订阅',
      emptyDescription: '选择一个套餐，开始使用更高额度的 API。',
      historyTitle: '订阅历史',
      historyEmpty: '暂无历史订阅。',
      colPlan: '套餐',
      colStatus: '状态',
      ...
      cancelTitle: '取消订阅？',
      cancelDescription:
        '在当前计费周期结束前你仍可继续使用 {planName}。此操作不可撤销。',
    ...
    purchase: {
      pageTitle: '选择套餐',
      pageSubtitle: '订阅以解锁更高额度与专属通道。',
      refresh: '刷新',
      retry: '重试',
      failedToLoad: '套餐加载失败',
      subscribe: '立即订阅',
      emptyTitle: '暂无可用套餐',
      emptyDescription: '请稍后再试，如有需要请联系客服。',
      promoLabel: '优惠码',
      promoPlaceholder: '输入优惠码（可选）',
      promoApply: '应用',
      promoClear: '清除',
      promoApplied: '优惠码已应用：{code}',
      providerTitle: '选择支付方式',
      providerStripe: 'Stripe（信用卡 / 支付宝 / 微信）',
      providerAirwallex: 'Airwallex',
      providerBalance: '余额支付',
      cancel: '取消',
      close: '关闭',
      continueToPayment: '继续支付',
      processing: '处理中...',
      checkoutError: '发起支付失败',
      period: {
        day: '/ {count} 天',
        month: '/ {count} 月',
        year: '/ {count} 年',
    ...
    billing: {
      pageTitle: '账单',
      pageSubtitle: '查看你的余额与交易历史。',
      refresh: '刷新',
      retry: '重试',
      balanceLabel: '当前余额',
      topUp: '充值',
      failedToLoadBalance: '余额加载失败',
      failedToLoadTxs: '交易记录加载失败',
      typeFilter: '类型',
      allTypes: '全部类型',
      startDate: '起始日期',
      endDate: '结束日期',
      ...
      colRef: '参考号',
      emptyTitle: '暂无交易记录',
      emptyDescription: '充值余额后即可开始使用付费功能。',
    ...
    topUp: {
      title: '余额充值',
      description: '向账户余额中添加额度。',
      amountLabel: '金额',
      amountPlaceholder: '例如 20',
      currencyLabel: '货币',
      providerLabel: '支付渠道',
      providerStripe: 'Stripe',
      providerAirwallex: 'Airwallex',
    ...
    usage: {
      pageTitle: '使用记录',
      pageSubtitle: '查看 API 用量、成本，并下载 CSV 报表。',
      refresh: '刷新',
      retry: '重试',
      exportCsv: '导出 CSV',
      exporting: '导出中…',
      exportSuccess: '已启动 CSV 导出',
      ...
      colStatus: '状态',
      colLatency: '延迟',
      emptyTitle: '该区间没有用量记录',
      emptyDescription: '试试放宽日期范围或清除筛选条件。',
      pageOf: '第 {page} / {pages} 页',
      prevPage: '上一页',
      nextPage: '下一页',
      errors: {
        summaryFailed: '聚合数据加载失败',
        listFailed: '用量明细加载失败',
        trendFailed: '图表数据加载失败',
      },
    },
    payment: {
      providers: {
        groupLabel: '支付渠道',
        stripe: 'Stripe',
        stripeHint: '通过 Stripe 使用信用卡、支付宝或微信支付',
        airwallex: 'Airwallex',
        airwallexHint: '通过 Airwallex 托管收银台使用信用卡',
        balance: '账户余额',
        balanceHint: '使用账户余额支付',
      },
      success: {
        pageTitle: '支付状态',
        pollingTitle: '正在确认你的支付…',
        pollingHint: '通常只需几秒钟。',
        doneTitle: '支付已确认',
        doneHint: '正在跳回你的账户…',
        pendingTitle: '仍在确认…',
        pendingHint:
          '支付提供商处理时间略长。你可以稍后重试，或在账单历史中查看结果。',
        failedTitle: '支付失败',
        failedHint: '我们无法确认你的支付。请重试或联系支持。',
        retry: '重试',
        goBilling: '前往账单',
        goSubs: '我的订阅',
        toast: '支付已确认。',
    ...
    profile: {
      title: '个人资料',
      description: '管理账户、安全、第三方登录与危险操作。',
      tabBasic: '基本信息',
      tabSecurity: '安全',
      tabConnections: '第三方登录',
      tabDanger: '危险区',
      basicsTitle: '基本信息',
      basicsDescription: '更新用户名、语言与时区。',
      email: '邮箱',
      avatar: '头像',
      avatarEmpty: '尚未设置头像',
      username: '用户名',
    ...
    security: {
      ...
      changePasswordDescription: '至少 8 个字符，建议混合字母、数字与符号。',
      currentPassword: '当前密码',
      newPassword: '新密码',
      confirmNewPassword: '确认新密码',
      changePasswordButton: '修改密码',
      ...
      errors: {
        ...
        NEW_TOO_SHORT: '新密码至少 8 个字符',
        CONFIRM_TOO_SHORT: '确认密码至少 8 个字符',
        CONFIRM_MISMATCH: '两次密码不一致',
        UNKNOWN: '未知错误',
      },
      totp: {
        title: '两步验证 (2FA)',
        description: '通过身份验证器 App 提升账户安全。',
        enabled: '已启用',
        notEnabled: '未启用',
        enable: '启用 2FA',
        disable: '关闭 2FA',
        loading: '加载中…',
        setupTitle: '设置两步验证',
        setupStep1: '使用身份验证器扫描下方二维码，然后输入 6 位验证码。',
        manualEntry: '或手动输入此密钥',
        enterCode: '输入 6 位验证码',
        verify: '验证并启用',
        verifying: '验证中…',
        cancel: '取消',
        invalidCode: '请输入 App 中的 6 位验证码',
        verifyFailed: '验证码错误，请重试',
        enableSuccess: '两步验证已启用',
        setupFailed: '加载设置失败',
        qrFailed: '二维码渲染失败',
        disableTitle: '关闭两步验证？',
        disableWarning: '关闭后账户仅依赖密码登录，建议保持开启。',
        enterPassword: '当前密码',
        confirmDisable: '确认关闭',
        disabling: '关闭中…',
        disableSuccess: '两步验证已关闭',
        disableFailed: '关闭失败',
        disableMissing: '请同时输入验证码与当前密码。',
      },
    },
    connections: {
      title: '第三方登录',
      description: '绑定或解绑第三方登录方式。',
      bind: '绑定',
      unbind: '解绑',
      cancel: '取消',
      confirmUnbind: '解绑',
      unbinding: '解绑中…',
      unbindTitle: '解绑此登录方式？',
      unbindDescription: '解绑后将无法用 {provider} 登录，请确认账户至少保留一种其他登录方式。',
      unbindSuccess: '已解绑 {provider}',
      unbindFailed: '解绑失败',
      empty: '管理员未启用任何第三方登录。',
      status: {
        bound: '已绑定',
    ...
    danger: {
      title: '注销账户',
      description: '永久删除账户及关联数据，不可恢复。',
      confirmEmail: '请输入完整邮箱以确认 ({email})',
      password: '当前密码',
      deleteButton: '删除我的账户',
      deleting: '删除中…',
      deleteSuccess: '账户已删除，正在退出登录…',
      deleteFailed: '删除账户失败',
    },
    affiliates: {
      pageTitle: '邀请返利',
      pageSubtitle: '邀请新用户、领取返利并申请提现。',
      refresh: '刷新',
      retry: '重试',
      loadFailed: '加载邀请信息失败',
      yourCode: '你的邀请码',
      ...
      stats: {
        ...
        available: '可用',
        frozen: '冻结',
        pendingWithdrawals: '提现中',
      },
      invited: {
        title: '邀请的用户',
        totalLabel: '共 {count} 人',
        empty: '暂无邀请记录',
        loadFailed: '加载邀请列表失败',
        colId: 'ID',
        colEmail: '邮箱',
    ...
    withdrawal: {
      title: '申请提现',
      description: '将可用返利提现到收款账户。',
      availableLabel: '可用返利',
      amountLabel: '金额',
      amountPlaceholder: '例如 50',
      destinationLabel: '收款方式',
      cancel: '取消',
      submit: '提交申请',
      submitting: '提交中…',
      success: '提现申请已提交。',
      ...
      errors: {
        ...
        AMOUNT_MIN: '金额不能少于 {min}。',
        AMOUNT_MAX: '金额不能超过可用返利 ({max})。',
        DETAILS_REQUIRED: '请填写收款信息。',
        UNKNOWN: '未知错误',
      },
    },
  },
