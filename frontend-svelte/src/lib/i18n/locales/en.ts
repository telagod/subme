export default {
  ...
  auth: {
    ...
    errors: {
      ...
      TOTP_INVALID: 'The verification code is invalid.',
  ...
  admin: {
    ...
    subscriptions: {
      ...
      // M22 · /(admin)/monetization/subscriptions admin surface
      desc: 'Live subscription ledger · manage cancellations, refunds and extensions',
      statActive: 'Active',
      statCancelled: 'Cancelled',
      statRevenue: 'MTD revenue',
      ...
      colExpires: 'Expires',
      colMtd: 'MTD',
      emptyText: 'No subscriptions match the current filters.',
      refundQuick: 'Refund',
      ...
      newExpiresAt: 'New expiry date',
      extendConfirm: 'Extend',
      extendSuccess: 'Subscription extended',
      extendError: 'Extend failed: {error}',
      cancelReason: 'Cancel reason',
      cancelReasonPlaceholder: 'Required (≥ 4 chars)',
      cancelReasonRequired: 'Reason is required (≥ 4 characters)',
      cancelConfirm: 'Force cancel',
    ...
    refund: {
      title: 'Issue refund',
      description: 'Refund will be processed via the original payment channel.',
      amount: 'Amount',
      maxHint: 'max ${max}',
      reason: 'Reason',
      reasonPlaceholder: 'Why is this refund being issued?',
      notifyUser: 'Notify user by email',
      confirm: 'Refund',
      submitting: 'Refunding…',
      success: 'Refund issued',
      error: 'Refund failed: {error}',
      errorAmountInvalid: 'Amount must be greater than 0',
      errorAmountExceeds: 'Amount exceeds refundable balance (max ${max})',
    ...
    settings: {
      ...
      defaults: {
        ...
        customGroupIdPlaceholder: 'Group ID',
        loadingGroups: 'Loading groups...',
        groupLoadFailed: 'Could not load groups. Enter group ID manually.',
      ...
      gatewayForwarding: {
        ...
        claudeOAuthSystemPromptInjectionHint: 'Inject Claude Code-like system blocks for Claude OAuth requests from non-Claude-Code clients. Enabled by default; disabling forwards the original system prompt untouched.',
        ...
        claudeOAuthSystemPromptHint: 'Controls only the third (expansion) injected system block. Use the Blocks JSON below for full control.',
        ...
        claudeOAuthSystemPromptBlocksHint: 'Each block has enabled, type, text, and optional cache_control. Placeholders: {billing_header}, {cc_version}, {fp}, {claude_code_system_prompt}, {claude_code_expansion_prompt}. cache_control accepts true (ephemeral 5m), false/null (none), or an object.',
      ...
      webSearchEmulation: {
        ...
        proxy: 'Proxy',
        noProxy: 'No proxy',
        customProxyId: 'Custom proxy ID',
        customProxyIdPlaceholder: 'Proxy ID',
        loadingProxies: 'Loading proxies...',
        proxyLoadFailed: 'Could not load proxies. Enter proxy ID manually.',
      ...
      payment: {
        ...
        invalidConfigJson: 'Credentials must be a JSON object',
        invalidLimitsJson: 'Limits must be valid JSON',
    ...
    accounts: {
      ...
      toolsErrorPassthrough: 'Error passthrough',
      toolsTLS: 'TLS profiles',
      ...
      refreshFiltered: 'Refresh filtered',
      refreshFilteredTitle: 'Refresh filtered accounts',
      editFiltered: 'Edit filtered',
      deleteFilteredTitle: 'Delete filtered accounts',
      filteredBulkDesc: 'This will affect all accounts matching current filters.',
      accounts: 'accounts',
      activated: 'Activated',
      disabled: 'Disabled',
      enable: 'Enable',
      ...
      statsTotal: 'Total',
      statsActive: 'Active',
      statsPoolMode: 'Pool mode',
      statsSchedulable: 'Schedulable',
      col: {
        account: 'Account',
        platform: 'Platform',
        status: 'Status',
      ...
      form: {
        name: 'Name', email: 'Email', notes: 'Notes', notesPlaceholder: 'Optional notes about this account',
        platform: 'Platform', type: 'Type', status: 'Status', proxyId: 'Proxy ID',
        credentials: 'Credentials', switchRawJson: 'Switch to raw JSON', switchStructured: 'Switch to structured',
        apiKey: 'API Key', baseUrl: 'Base URL', baseUrlHint: 'Custom API endpoint. Leave empty for default.',
        orgId: 'Organization ID', projectId: 'Project ID', tierId: 'Tier ID',
        interceptWarmup: 'Intercept warmup requests', webSearch: 'Web search mode',
        oauthHint: 'OAuth credentials are managed via the ReAuth flow. Use raw JSON to edit manually.',
        credentialsJson: 'Credentials JSON',
        priority: 'Priority', weight: 'Weight', concurrency: 'Concurrency', rateMultiplier: 'Rate multiplier',
        groupIds: 'Group IDs', schedulable: 'Schedulable', privacyMode: 'Privacy mode', poolMode: 'Pool mode',
        modelRestriction: 'Model restriction',
      },
      data: {
        batchCreate: 'Batch create', batchCreateHint: 'Paste an array of account payloads.',
        createBatchBtn: 'Create batch', batchCreated: 'Batch created',
        selectedUpdates: 'Selected updates', selectedUpdatesHint: 'Apply JSON updates or one credential field to selected accounts.',
        credFieldPlaceholder: 'Credential field', credValuePlaceholder: 'Credential value or JSON',
        updateCredBtn: 'Update credential', credUpdated: 'Credentials updated',
        applyUpdateBtn: 'Apply update', updated: 'Accounts updated',
        importExport: 'Import / export data', importExportHint: 'Export selected accounts to JSON, or paste data to import.',
        importBtn: 'Import data', imported: 'Imported', exported: 'Exported',
        mustBeArray: 'Must be array or { accounts: [] }',
      },
      tools: {
        requests: 'Requests', tokens: 'Tokens', cost: 'Cost', usageSource: 'Usage source',
        runtimeActions: 'Runtime actions', runtimeActionsHint: 'Operational controls for upstream account health and quota state.',
        stateRecovered: 'State recovered', rateLimitCleared: 'Rate limit cleared', quotaReset: 'Quota reset',
        models: 'Models', modelsHint: 'Supported upstream model list.',
        scheduledTests: 'Scheduled tests', scheduledTestsHint: 'Run recurring account connectivity tests.',
        testModel: 'Test model', mode: 'Mode', manualModel: 'Manual model', imagePrompt: 'Image prompt',
        readyTest: 'Ready to test account connectivity.',
        openaiResetCredits: 'OpenAI reset credits', openaiResetHint: 'Query upstream reset credits before consuming one reset.',
        queryQuota: 'Query OpenAI quota', useResetCredit: 'Use reset credit',
        modelId: 'Model ID', cron: 'Cron', maxResults: 'Max results',
        enabled: 'Enabled', autoRecover: 'Auto recover',
        savePlan: 'Save plan', saveEdit: 'Save edit', addPlan: 'Add plan',
        noModels: 'No models reported.', noPlans: 'No scheduled test plans.',
        loadingResults: 'Loading results...', noResults: 'No results yet.',
        hideResults: 'Hide results', results: 'Results',
        planUpdated: 'Plan updated', planDeleted: 'Plan deleted',
        modelCronRequired: 'Model and cron required',
      },
      advanced: {
        errorPassthroughRules: 'Error passthrough rules', createRule: 'Create passthrough rule',
        username: 'Username', password: 'Password', syncProxies: 'Sync proxies',
      },
      reauth: {
        mode: 'Mode', state: 'State', code: 'Code', exchangeCode: 'Exchange code',
        cookieKey: 'Cookie session key',
      },
      modelWhitelist: {
        noSelected: 'No models selected', noMatching: 'No matching models', clearAll: 'Clear all',
        customModel: 'Custom model', add: 'Add',
      },
    },
    ...
    accountsQuench: {
      ...
      autoRefreshOff: 'Off',
      autoRefreshCountdown: '{sec}s',
      autoRefreshTitle: 'Auto Refresh Settings',
      enableAutoRefresh: 'Enable Auto Refresh',
      refreshInterval5s: '5 seconds',
      refreshInterval10s: '10 seconds',
      refreshInterval15s: '15 seconds',
      refreshInterval30s: '30 seconds',
      listPendingSyncHint: 'List has new changes',
      listPendingSyncAction: 'Refresh',
      columnSettingsLabel: 'Columns',
      columnSettingsTitle: 'Column Visibility',
      columnSettingsReset: 'Reset to Default',
      columnSettingsHidden: '{n} hidden',
      filterSchedulable: 'Schedulable',
      filterSchedulableYes: 'Schedulable',
      filterSchedulableNo: 'Not Schedulable',
      filterHasProxy: 'Proxy',
      filterHasProxyYes: 'Has Proxy',
      filterHasProxyNo: 'No Proxy',
      filtersToggleShow: 'Filters',
      filtersToggleHide: 'Hide Filters',
      filtersClearAll: 'Clear',
      bulkDeleteFiltered: 'Delete All Filtered',
      bulkEditFiltered: 'Edit All Filtered',
      bulkRetryFailed: 'Retry Failed',
      bulkDeleteFilteredTitle: 'Delete All Filtered Accounts',
      bulkDeleteFilteredMsg: 'Delete {count} accounts matching current filters? This action is irreversible.',
      bulkDeleteNoMatch: 'No accounts match current filters.',
      bulkDeletePartial: 'Partial success: {success} ok, {failed} failed.',
      bulkDeleteSuccess: 'Deleted {count} accounts.',
      bulkSchedulableEnabled: '{count} accounts enabled for scheduling.',
    ...
    accountTablePanel: {
      ...
      colAntigravityTier: 'Tier',
      colOpenAICompact: 'Compact',
      ...
      moreBtn: 'More',
      expired: 'Expired',
      autoPauseOnExpired: 'Auto-Pause',
      tierFree: 'Free',
      tierPro: 'Pro',
      tierUltra: 'Ultra',
      compactSupported: 'Active',
      compactUnsupported: 'Blocked',
      compactAuto: 'Auto',
      compactLastChecked: 'Last checked',
      proxyFallbackActive: 'Fallback',
      proxyFallbackOriginTip: 'Fallback from proxy #{origin}',
      proxyRevert: 'Revert',
      proxyRevertSuccess: 'Reverted to original proxy.',
      proxyRevertFailed: 'Revert failed.',
      proxyDaysRemaining: '{days}d left',
    ...
    pricingList: {
      title: 'PayGo Pricing',
      subtitle: 'Browse all billable models with their official pricing — click any row for per-provider detail and override.',
      totalCount: 'models billable',
      sourceHint: 'Source: OpenRouter + LiteLLM',
      ...
      provider: {
        label: 'Provider',
        allOption: 'All providers',
      },
      sort: {
        label: 'Sort',
        providerGroup: 'Group by provider',
        alphaAsc: 'Model A-Z',
        inputAsc: 'Input price asc',
        inputDesc: 'Input price desc',
        outputAsc: 'Output price asc',
        outputDesc: 'Output price desc',
        contextDesc: 'Context window desc',
      },
      onlyOverridden: 'Only overridden',
      providerTabs: {
        all: 'All',
      },
      mainstreamHint: 'Curated mainstream providers',
      overrideTooltip: 'Overridden',
      mainstreamSummary: '{models} models · {providers} mainstream providers',
      columns: {
        model: 'Model',
        provider: 'Provider',
        input: 'Input',
      ...
      empty: {
        ...
        hint: 'Sync the catalog to pull the latest models and pricing from OpenRouter.',
        action: 'Sync catalog',
      },
    },
    ...
    plansCatalog: {
      ...
      dialogDesc: 'Configure plan metadata, pricing and entitlements',
      quotasFromGroup: 'Quotas are inherited from the selected group',
      quotasNeedGroup: 'Select a group on the Basic Info tab to view inherited quotas',
      unitDays: 'Days',
      unitWeeks: 'Weeks',
      unitMonths: 'Months',
    },
  ...
  // User-side namespace (M6 dashboard onward)
  user: {
    dashboard: {
      ...
      chart: {
        ...
        loading: 'Loading chart…',
        empty: 'No usage in the last 7 days',
        failed: 'Failed to load chart',
      },
      recent: {
        ...
        emptyCta: 'Create an API key',
        emptyHint: 'Start by creating an API key.',
      },
      errors: {
    ...
    keys: {
      pageTitle: 'API Keys',
      pageSubtitle: 'Create and manage your API keys for programmatic access.',
      newKey: 'New API Key',
      refresh: 'Refresh',
      retry: 'Retry',
      loading: 'Loading…',
      ...
      revealDescription: "Copy this key now. We won't show it again.",
      revealWarning: "This is the only time we'll display the full key. Store it somewhere safe.",
      mustSaveKeyWarning: 'Please copy the key or confirm you have saved it before closing.',
      savedAcknowledge: "I've saved this key in a secure location",
      copyToClipboard: 'Copy to clipboard',
      copiedToast: 'Copied to clipboard',
      copyFailed: 'Failed to copy. Select and copy manually.',
      create: 'Create',
      creating: 'Creating...',
      nameLabel: 'Name',
      namePlaceholder: 'My API key',
      quotaLabel: 'Quota (USD, optional)',
      quotaPlaceholder: 'Leave empty for unlimited',
      expiresLabel: 'Expires in (days, optional)',
      expiresPlaceholder: 'e.g. 30 — leave empty for no expiry',
      ...
      errors: {
        ...
        QUOTA_NEGATIVE: 'Quota must be a non-negative number',
        EXPIRES_INT: 'Expiry must be an integer number of days',
        EXPIRES_MIN: 'Expiry must be at least 1 day',
        EXPIRES_MAX: 'Expiry cannot exceed 365 days',
        UNKNOWN: 'Unknown error',
      },
    },
    subscriptions: {
      pageTitle: 'My Subscriptions',
      pageSubtitle: 'Manage your active subscription and review past plans.',
      refresh: 'Refresh',
      retry: 'Retry',
      failedToLoad: 'Failed to load subscription',
      currentLabel: 'Current subscription',
      startedAt: 'Started',
      renewsAt: 'Renews at',
      expiringSoon: 'This subscription is about to expire. Renew to keep access.',
      cancel: 'Cancel',
      upgrade: 'Upgrade',
      browsePlans: 'Browse plans',
      emptyTitle: 'No active subscription',
      emptyDescription: 'Pick a plan to start using the API beyond the free quota.',
    ...
    purchase: {
      ...
      pageSubtitle: 'Subscribe to unlock higher quota and dedicated channels.',
      refresh: 'Refresh',
      retry: 'Retry',
      failedToLoad: 'Failed to load plans',
      subscribe: 'Subscribe',
      emptyTitle: 'No plans available',
      emptyDescription: 'Check back later or contact support if you expect plans to be here.',
      promoLabel: 'Promo code',
      promoPlaceholder: 'Enter code (optional)',
      promoApply: 'Apply',
      promoClear: 'Clear',
      promoApplied: 'Promo code applied: {code}',
      providerTitle: 'Choose a payment method',
      providerStripe: 'Stripe (Card / Alipay / WeChat)',
      providerAirwallex: 'Airwallex',
    ...
    billing: {
      pageTitle: 'Billing',
      pageSubtitle: 'Review your balance and transaction history.',
      refresh: 'Refresh',
      retry: 'Retry',
      ...
      emptyDescription: 'Top up your balance to start using paid features.',
    ...
    topUp: {
      ...
      successToast: 'Top-up order created.',
      errors: {
    ...
    usage: {
      pageTitle: 'Usage',
      pageSubtitle: 'Review API usage, costs, and download CSV reports.',
      refresh: 'Refresh',
      retry: 'Retry',
      exportCsv: 'Export CSV',
      exporting: 'Exporting…',
      ...
      errors: {
        ...
        listFailed: 'Failed to load usage entries',
        trendFailed: 'Failed to load chart data',
      },
    },
    payment: {
      providers: {
        ...
        stripe: 'Stripe',
        stripeHint: 'Card, Alipay or WeChat via Stripe',
        airwallex: 'Airwallex',
        airwallexHint: 'Card via Airwallex hosted checkout',
        balance: 'Account balance',
        balanceHint: 'Pay using your account balance',
      },
      success: {
        pageTitle: 'Payment status',
        pollingTitle: 'Confirming your payment…',
        pollingHint: 'This usually takes a few seconds.',
        doneTitle: 'Payment confirmed',
        doneHint: 'Redirecting you back to your account…',
        pendingTitle: 'Still confirming…',
        pendingHint:
          'Your payment provider is taking longer than expected. You can retry or check back later in your billing history.',
        failedTitle: 'Payment failed',
        failedHint: 'We could not confirm your payment. Please retry or contact support.',
        retry: 'Retry',
        goBilling: 'Go to billing',
        goSubs: 'My subscriptions',
        toast: 'Payment confirmed.',
        failedToast: 'Payment did not complete.',
      },
      cancel: {
        pageTitle: 'Payment canceled',
        title: 'Payment canceled',
        description: 'You canceled the payment. No charges were made.',
    ...
    profile: {
      title: 'Profile Settings',
      description: 'Manage your account, security, connections, and danger-zone actions.',
      tabBasic: 'Basic Info',
      tabSecurity: 'Security',
      tabConnections: 'Connections',
      tabDanger: 'Danger Zone',
      basicsTitle: 'Basic information',
      basicsDescription: 'Update your username, language, and timezone.',
      email: 'Email',
      avatar: 'Avatar',
    ...
    security: {
      ...
      changePasswordDescription: 'Use at least 8 characters. Mix letters, numbers, and symbols.',
      currentPassword: 'Current password',
      newPassword: 'New password',
      confirmNewPassword: 'Confirm new password',
      changePasswordButton: 'Change password',
      ...
      errors: {
        ...
        CONFIRM_TOO_SHORT: 'Confirmation must be at least 8 characters',
      ...
      totp: {
        ...
        setupTitle: 'Set up two-factor authentication',
        setupStep1: 'Scan the QR code below with your authenticator app, then enter the 6-digit code.',
        ...
        verifyFailed: 'Invalid code, try again',
        enableSuccess: 'Two-factor authentication enabled',
        setupFailed: 'Failed to load setup',
        qrFailed: 'Failed to render QR code',
        disableTitle: 'Disable two-factor authentication?',
        disableWarning: 'After disabling, your account will rely on password only. We recommend keeping 2FA on.',
        enterPassword: 'Current password',
        confirmDisable: 'Confirm disable',
        disabling: 'Disabling…',
        disableSuccess: 'Two-factor authentication disabled',
        disableFailed: 'Failed to disable',
        disableMissing: 'Enter both your authenticator code and current password.',
      },
    },
    connections: {
      title: 'Connected sign-in methods',
      ...
      unbinding: 'Unlinking…',
      unbindTitle: 'Unlink this sign-in method?',
      unbindDescription: 'You will no longer be able to log in with {provider}. Make sure another sign-in method is available.',
      unbindSuccess: '{provider} unlinked',
      unbindFailed: 'Failed to unlink account',
      empty: 'No third-party providers are enabled by the administrator.',
      status: {
        bound: 'Linked',
        notBound: 'Not linked',
      },
    ...
    danger: {
      ...
      confirmEmail: 'Type your email to confirm ({email})',
      password: 'Current password',
      deleteButton: 'Delete my account',
      deleting: 'Deleting…',
      deleteSuccess: 'Account deleted. Logging out…',
      deleteFailed: 'Failed to delete account',
    },
    affiliates: {
      pageTitle: 'Affiliates',
      pageSubtitle: 'Invite users, earn rebates, and request withdrawals.',
      refresh: 'Refresh',
      retry: 'Retry',
      loadFailed: 'Failed to load affiliate info',
      ...
      invited: {
        ...
        empty: 'No invited users yet',
        loadFailed: 'Failed to load invitees',
        colId: 'ID',
        colEmail: 'Email',
        colJoined: 'Joined',
        colSpend: 'Spend',
      ...
      rebates: {
        ...
        loadFailed: 'Failed to load rebate ledger',
        allStatuses: 'All statuses',
        colTimestamp: 'Timestamp',
        colSource: 'Source',
        colAmount: 'Amount',
    ...
    withdrawal: {
      ...
      description: 'Withdraw your available rebate to a payout destination.',
      ...
      errors: {
        ...
        AMOUNT_MAX: 'Amount cannot exceed available rebate ({max}).',
        DETAILS_REQUIRED: 'Please fill in the destination details.',
        UNKNOWN: 'Unknown error',
      },
    },
  },
