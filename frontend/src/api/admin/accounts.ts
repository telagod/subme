...
/**
 * OpenAI / Codex rate-limit reset feature: query upstream usage and consume reset credits.
 *
 * Backed by the admin handler at
 *   GET  /admin/openai/accounts/:id/quota
 *   POST /admin/openai/accounts/:id/reset-quota
 * which proxy chatgpt.com's /wham/usage and
 ...
 *
 * This is a destructive upstream action (one credit is spent permanently);
 * callers are expected to surface a confirmation prompt before invoking.
 */
