# Subme Deployment Files

This directory contains files for deploying Subme on Linux servers.
...
curl -sSL https://raw.githubusercontent.com/telagod/subme/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
Subme supports three methods to connect to Gemini:
...
1. Download the latest release from [GitHub Releases](https://github.com/telagod/subme/releases)
...
Subme supports TLS fingerprint simulation to make requests appear as if they come from the official Claude CLI (Node.js client).
