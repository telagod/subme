#!/bin/bash
#
# Subme Installation Script
# Subme 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/telagod/subme/main/deploy/install.sh | bash
#
...
declare -A MSG_ZH=(
    ...
    # Completion
    ["install_complete"]="Subme 安装完成！"
    ["install_dir"]="安装目录"
    ["next_steps"]="后续步骤"
    ["step1_check_services"]="确保 PostgreSQL 和 Redis 正在运行："
    ["step2_start_service"]="启动 Subme 服务："
    ...
    ["not_installed"]="Subme 尚未安装，请先执行全新安装"
    ["fresh_install_hint"]="用法"

    # Uninstall
    ["uninstall_confirm"]="这将从系统中移除 Subme。"
    ...
    ["uninstall_complete"]="Subme 已卸载"

    # Help
    ["usage"]="用法"
    ["cmd_none"]="(无参数)"
    ["cmd_install"]="安装 Subme"
    ["cmd_upgrade"]="升级到最新版本"
    ["cmd_uninstall"]="卸载 Subme"
    ...
    ["server_config_desc"]="配置 Subme 服务监听地址"
...
declare -A MSG_EN=(
    ...
    # Installation
    ["install_title"]="Subme Installation Script"
    ...
    # Completion
    ["install_complete"]="Subme installation completed!"
    ["install_dir"]="Installation directory"
    ["next_steps"]="NEXT STEPS"
    ["step1_check_services"]="Make sure PostgreSQL and Redis are running:"
    ["step2_start_service"]="Start Subme service:"
    ...
    ["not_installed"]="Subme is not installed. Please run a fresh install first"
    ["fresh_install_hint"]="Usage"

    # Uninstall
    ["uninstall_confirm"]="This will remove Subme from your system."
    ...
    ["uninstall_complete"]="Subme has been uninstalled"

    # Help
    ["usage"]="Usage"
    ["cmd_none"]="(none)"
    ["cmd_install"]="Install Subme"
    ["cmd_upgrade"]="Upgrade to the latest version"
    ["cmd_uninstall"]="Remove Subme"
    ...
    ["server_config_desc"]="Configure Subme server listen address"
...
[Unit]
Description=Subme - AI API Gateway Platform
Documentation=https://github.com/telagod/subme
...
# Requires: Subme must already be installed
install_version() {
